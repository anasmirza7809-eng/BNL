...
import { n as bnl_icon_white_png_asset_default } from "./header-Boyy3Tyj.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/footer-DKq7yCTl.js
var import_jsx_runtime = require_jsx_runtime();
function Footer() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
		className: "bg-primary text-primary-foreground",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-4 lg:px-10",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: "mt-6 max-w-sm text-sm text-background/70 leading-relaxed",
					children: "We connect you to premium real estate opportunities in Dubai & India. Your trust is our legacy."
				})] }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "text-[11px] tracking-[0.28em] uppercase text-accent",
					children: "Quick Links"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
					className: "mt-4 space-y-2 text-sm text-background/75",
					children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "mt-4 space-y-2 text-sm text-background/75",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Dubai Properties" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Indian Properties" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "Land Investment" })
					]
				})] }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "text-[11px] tracking-[0.28em] uppercase text-accent",
					...
					className: "mt-4 space-y-3 text-sm text-background/75",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
								...
								className: "hover:text-accent",
								children: "WhatsApp +971 54 304 3949"
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							className: "flex items-center gap-2",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Office No. 4, Al Khabeesi Building, Dubai, United Arab Emirates" })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mx-auto max-w-7xl px-6 py-6 text-center text-xs text-background/60 lg:px-10",
				children: [
					"© ",
					(/* @__PURE__ */ new Date()).getFullYear(),
					" Bricks & Legacy Real Estate. All Rights Reserved."
				]
			})
		})]
	});
