...
//#region node_modules/.nitro/vite/services/ssr/assets/property-image-CPGMeRam.js
...
function usePropertyImageSrc(imagePath, imageUrl, fallback, gallery) {
	...
	(0, import_react.useEffect)(() => {
		...
		supabase.storage.from("property-images").createSignedUrl(target, 86400).then(({ data }) => {
