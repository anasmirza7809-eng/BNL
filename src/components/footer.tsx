      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-4 lg:px-10">
        <div>
          <div className="flex items-center gap-3">
            <img src={logoAsset.url} alt="Bricks & Legacy" className="h-12 w-12 object-contain" />
            <div>
              <div className="font-serif text-xl">Bricks &amp; Legacy</div>
            </div>

          </div>
          <p className="mt-6 max-w-sm text-sm text-background/70 leading-relaxed">
            We connect you to premium real estate opportunities in Dubai &amp; India. Your trust is our legacy.
          </p>
        </div>
        <div>
          <div className="text-[11px] tracking-[0.28em] uppercase text-accent">Quick Links</div>
        ...
        <div>
          <div className="text-[11px] tracking-[0.28em] uppercase text-accent">Properties</div>
          <ul className="mt-4 space-y-2 text-sm text-background/75">
            <li>Dubai Properties</li>
            <li>Indian Properties</li>
            <li>Land Investment</li>
          </ul>
        </div>
        <div>
          <div className="text-[11px] tracking-[0.28em] uppercase text-accent">Contact Us</div>
          <ul className="mt-4 space-y-3 text-sm text-background/75">
            <li className="flex items-center gap-2">
              ...
              <a href="tel:+971543043949" className="hover:text-accent">+971 54 304 3949</a>
            </li>
            <li className="flex items-center gap-2">
              ...
              <a href="https://wa.me/971543043949" target="_blank" rel="noopener noreferrer" className="hover:text-accent">WhatsApp +971 54 304 3949</a>
            </li>
            <li className="flex items-center gap-2">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="shrink-0 text-accent">
              ...
              <a href="mailto:info@bricksandlegacy.com" className="hover:text-accent">info@bricksandlegacy.com</a>
            </li>
            <li className="flex items-start gap-2">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="mt-0.5 shrink-0 text-accent">
                <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" />
                <circle cx="12" cy="10" r="3" />
              </svg>
              <span>Office No. 4, Al Khabeesi Building, Dubai, United Arab Emirates</span>
            </li>
            <li className="flex items-center gap-2">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="shrink-0 text-accent">
              ...
              <a href="https://www.instagram.com/bricksandlegacy?igsh=Y3ZvbnBpc2J3NGk5&utm_source=qr" target="_blank" rel="noopener noreferrer" className="hover:text-accent">@bricksandlegacy</a>
            </li>
            <li className="flex items-center gap-2">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="ml-0.5 shrink-0 text-accent">
              ...
              <a href="https://www.linkedin.com/company/bricks-and-legacy/" target="_blank" rel="noopener noreferrer" className="hover:text-accent">Bricks &amp; Legacy</a>
            </li>
          </ul>
        </div>
      </div>
      <div className="border-t border-background/15">
        <div className="mx-auto max-w-7xl px-6 py-6 text-center text-xs text-background/60 lg:px-10">
          © {new Date().getFullYear()} Bricks &amp; Legacy Real Estate. All Rights Reserved.
        </div>
      </div>
    </footer>
  );
